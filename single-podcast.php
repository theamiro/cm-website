...
<header class="relative bg-no-repeat bg-cover bg-top h-[160px]"
        style="clip-path: polygon(0 0, 100% 0, 100% 70%, 0 100%); background-image: url(<?php if(has_post_thumbnail(get_the_ID())) : echo get_the_post_thumbnail_url(get_the_ID(),'full'); else: echo get_stylesheet_directory_uri() . '/assets/images/hero-image.png'; endif;?>);">
</header>
